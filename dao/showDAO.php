...
class ShowDAO
{
    ...
    public function GetAllShows()
    {
        ...
        $query = "SELECT idshow, showname, id_image, 'description' FROM ".$this->tableName." S inner join presentations P on S.idshow = P.idshow where P.date > now() group by S.idshow";
    ...
    public function GetShowsByCategory($idcategory)
    {
        ...
        $query = "SELECT idshow, showname, id_image, 'description'".
    ...
    public function GetShowsByArtist($idArtist)
    {
        ...
        $query = "SELECT idshow, showname, id_image, 'description' FROM shows S ".
