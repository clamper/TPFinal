                ...
                <div class="card">
                    <div class="card-body" id="days">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="customRadio" name="days_radio" value="only" checked>
                        ...
                        <div id="only_day">
                            <div class="card">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <button type="button" class="btn bg-info" id="select_artist" data-toggle="modal" data-target="#modal_artist">seleccionar artistas</button>
                                </div>
                            </div>
                        </div>
